...
data class Day(private var mTime: Long, private var mSummary: String, private var mTemperatureMax: Double, private var mIcon: String, private var mTimezone: String)